const Contact = () => {
  return (
    <section className="text-center">
      <p className="text-main text-2xl mb-3">What&apos;s next?</p>
      ...
      <a
        ...
        target="_blank"
        className="block text-lg max-w-max mx-auto p-4 pl-8 pr-8 border-2 border-main rounded-full mt-20 mb-20 text-main hover:text-white hover:bg-main transition-all duration-300"
      >
        Say Hello
      </a>
    </section>
